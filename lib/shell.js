    ...
    start() {
        ...
        face.on('line', (line) => {
            ...
            if (!line || line === '') {
                ...
                if (this.__error.inputNothing) console.log(this.__error.inputNothing);
            } else {
                ...
                if (instruction === 'exit') {
                    ...
                    if (this.__onExit) this.__onExit();
                ...
                for (let i = 0; i < this.__listens.length; i++) {
                    if (instruction === this.__listens[i].instruction) {
                        ...
                        if (this.__onCaught) this.__onCaught(instruction, params);
                ...
                if (!find) {
                    if (this.__error.noMatchedInstruction) console.log(this.__error.noMatchedInstruction);
                }
            }
